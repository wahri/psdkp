    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            with font-awesome or any other icon font library -->
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('dashboard.locker.*') || request()->routeIs('dashboard.user.*') || request()->routeIs('dashboard.category.*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/dashboard/locker"
                                        class="nav-link {{ request()->routeIs('dashboard.locker.*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
